...
public class PQDemo {
    public static void main(String[] args) {
        ...
        // as determined by the compareTo method in the FullName class and the sortOrder
        // attribute
        ...
        while (!s.isEmpty()) {
            // popping an element off the stack returns that element and removes it from the
            // stack
        ...
        System.out.println("Here's the treeSet of FullNames using an iterator: ");
        for (FullName name : nameSet) {
            System.out.println(name);
        }
        //is the set empty after iterating over it ?
        System.out.println("Is the treeSet empty? " + nameSet.isEmpty());
        //sets and lists have non-destructive iteration; stacks and queues have destructive iteration
        //deifference between destructive and non-destructive iteration is wheter the iteration accessing the element
