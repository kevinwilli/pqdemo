...
/**
 * This class represents a person's full name.  It implements the Comparable
 * interface so that any FullName object can compare itself to another
 * FullName object.
 * 
 * @param firstName
 * @param lastName
...
public class FullName implements Comparable<FullName> {
    ...
    // constructors
    /**
     * This constructor creates a FullName object with a random first name
     * and a random last name.
     * 
     * @return void
     */
    public FullName() {
...
/**
 * This constructor creates a FullName object with the specified first name
 * and last name.
 * @param firstName
 * @param lastName
 */
    ...
    /**
     * This method returns the last name of the FullName object.
